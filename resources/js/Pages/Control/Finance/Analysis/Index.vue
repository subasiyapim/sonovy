<template>
  <AdminLayout :showDatePicker="false"  :title="__('control.finance.analysis.header')" parentTitle="Katalog">
    ...
    <template #toolbar>
    <div class="w-48">
        <VueDatePicker @update:model-value="onDateChoosen" :max-date="choosenDate[0]" v-model="choosenDate"  range  month-picker   multi-calendars  class="radius-8" auto-apply :enable-time-picker="false" placeholder="Tarih Giriniz">
            <template #input-icon>
                <div class="p-3">
