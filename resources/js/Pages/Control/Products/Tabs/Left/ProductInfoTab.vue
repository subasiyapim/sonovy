<template>
  ...
  <div class="flex gap-10">
    ...
    <div class="flex-1 flex flex-col overflow-scroll gap-6">
      ...
      <FormElement label-width="190px" :error="form.errors.featuring_artists" v-model="form.featuring_artists"
      ...
      <FormElement label-width="190px" :error="form.errors.genre_id" v-model="form.genre_id" label="Tarz"
                   placeholder="Seçiniz" type="select" :config="genreConfig">

      </FormElement>
      <FormElement label-width="190px" :error="form.errors.sub_genre_id" v-model="form.sub_genre_id" label="Alt Tarz"
                   placeholder="Seçiniz" type="select" :config="genreConfig">
      </FormElement>
    ...
    <div class="flex-1 flex flex-col overflow-scroll gap-6">
      <FormElement type="select" :error="form.errors.label_id" v-model="form.label_id" label-width="190px"
                   label="Plak şirketi" placeholder="Şirket Seçiniz" :config="labelConfig"></FormElement>
      <FormElement label-width="190px" :error="form.errors.p_line" v-model="form.p_line" label="p Satırı"
      ...
      <FormElement label-width="190px" :error="form.errors.c_line" v-model="form.c_line" label="C Satırı"
                   placeholder="Lütfen giriniz"></FormElement>
      ...
      <FormElement type="select" label-width="190px" :error="form.errors.language_id" v-model="form.language_id"
      ...
      <FormElement type="select" label-width="190px" :error="form.errors.main_price" v-model="form.main_price"
