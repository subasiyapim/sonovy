        ...
        $earnings = Earning::query()
            ...
            ->map(function ($earning) {
                return [
                    ...
                    'total_earning' => Number::currency($earning->user_total_earning * ($earning->user?->commission_rate ?? 0), 'USD', app()->getLocale()),
                    'provider_earning' => Number::currency(($earning->user_total_earning * ($earning->user?->commission_rate ?? 0)) - $earning->user_total_earning, 'USD', app()->getLocale()),
