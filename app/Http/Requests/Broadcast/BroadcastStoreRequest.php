...
class BroadcastStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return match (intval($this->type)) {
            ...
            BroadcastTypeEnum::SOUND->value, BroadcastTypeEnum::RINGTONE->value => $this->soundRules(),
            BroadcastTypeEnum::VIDEO->value => $this->videoRules(),
            default => [],
        };
    }
    ...
    protected function commonRules(): array
    {
        $validated_data = [
            ...
            'type' => ['required', 'in:' . BroadcastTypeEnum::SOUND->value . ',' . BroadcastTypeEnum::VIDEO->value . ',' . BroadcastTypeEnum::RINGTONE->value],
            'version' => ['nullable'],
    ...
    {
        return [
            'type' => __('panel.broadcast.form.type'),
            'label_id' => __('panel.broadcast.label_company'),
            'right_to_perform_work' => __('panel.broadcast.form.right_to_perform_work'),
            'has_audiovisual_rights' => __('panel.broadcast.form.has_audiovisual_rights'),
            'copyright_for_publication_image' => __('panel.broadcast.form.copyright_for_publication_image'),
            'publisher_name' => __('panel.broadcast.form.publisher_name'),
            'is_for_children' => __('panel.broadcast.form.is_for_children'),
            'youtube_channel' => __('panel.broadcast.form.youtube_channel'),
            'youtube_channel_theme' => __('panel.broadcast.form.youtube_channel_theme'),
            'description' => __('panel.broadcast.form.description'),
            'hashtags' => __('panel.broadcast.form.hashtags'),
            'hashtags.*' => __('panel.broadcast.form.hashtags.*'),
            'name' => __('panel.broadcast.form.name'),
